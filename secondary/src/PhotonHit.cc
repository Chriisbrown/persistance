...
PhotonHit::PhotonHit()
  :  G4VHit(), fPmtNumber(-1), fPhotons(0), fPathLength(0), fTimeStep(0), fReflectionNumber(0) {}
  ...
  : G4VHit()
{
  ...
  fTimeStep=right.fTimeStep;
  fReflectionNumber=right.fReflectionNumber;
...
{
  G4cout << "  pmtnumber: " << fPmtNumber << "  photons: " << fPhotons
         << " Path Length: " << fPathLength << "Time Step: "<< fTimeStep
         << "Reflection Number" << fReflectionNumber <<  G4endl;
}
