...
class LXeMainVolume : public G4PVPlacement
{
  ...
  private:
    ...
    G4LogicalVolume* fPmt_log2;
    G4LogicalVolume* fPmt_log3;
    G4LogicalVolume* fPmt_log4;
    G4LogicalVolume* fPmt_log5;
    G4LogicalVolume* fPmt_log6;
    G4LogicalVolume* fPmt_log7;
    G4LogicalVolume* fPmt_log8;
